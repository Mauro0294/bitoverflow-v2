...
<body class='bg-[#181818]'>
    <div class='px-24 py-12'>
        ...
        <section class='mx-auto w-[850px] font-bold mt-32 relative'>
            ...
            <img src='images/blue.png' style='right: -300px' class='absolute top-40'>
        </section>
        <section class='relative'>
            <img src='images/gradient.png' style='bottom: -300px; left: -100px' class='absolute z-0'>
            <img src='images/screen_mockup.svg' class='mx-auto mt-32 relative z-1'>
        </section>
    </div>
    <section class='bg-[#1F1F1F] text-white mt-40 p-24'>
        <h2 class='text-5xl'>Zeker weten dat je de juiste hulp krijgt</h2>
    </section>
</body>
</html>